...
**6)**
<ul>
   <li>6.1) To maintain the authentication services which all other services depend upon, the Active Directory should be migrated first to ensure it is functional before migrating its dependants.</li>
   <li>6.2) Next, the Application, Web, and SQL servers should be migrated togerther as they are business critical and would cause down-time if anyone of them are un-available </li>
   <li>6.2) Migration Order: (DC-01) -> (WEB-01, APP-01, DB-01) ->(FILE-01)</li>
</ul>
